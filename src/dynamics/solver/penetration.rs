...
use solver::xpbd::{PositionConstraint, XpbdConstraint};
...
impl XpbdConstraint<2> for PenetrationConstraint {
    ...
    fn solve(&mut self, bodies: [&mut RigidBodyQueryItem; 2], dt: Scalar) {
        ...
        let p1 = body1.current_position() + *body1.rotation * self.contact.point1;
        let p2 = body2.current_position() + *body2.rotation * self.contact.point2;
...
impl PenetrationConstraint {
    ...
    fn solve_contact(
        ...
        let r1 = *body1.rotation * self.r1;
        let r2 = *body2.rotation * self.r2;
    ...
    fn solve_friction(
        ...
        let delta_p1 = body1.current_position() - body1.previous_position.0
            + *body1.rotation * self.contact.point1
            - body1.previous_rotation.0 * self.contact.point1;
        let delta_p2 = body2.current_position() - body2.previous_position.0
            + *body2.rotation * self.contact.point2
            - body2.previous_rotation.0 * self.contact.point2;
