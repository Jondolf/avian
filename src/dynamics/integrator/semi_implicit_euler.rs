...
pub fn integrate_velocity(
    ...
    torque: TorqueValue,
    mass: RigidBodyMass,
    angular_inertia: RigidBodyAngularInertia,
...
pub fn angular_acceleration(
    torque: TorqueValue,
    global_angular_inertia: RigidBodyAngularInertia,
    locked_axes: LockedAxes,
) -> AngularValue {
    ...
    if effective_angular_inertia != RigidBodyAngularInertia::INFINITY
...
mod tests {
    ...
    fn semi_implicit_euler() {
        ...
        let mass = RigidBodyMass::new(1.0);
        #[cfg(feature = "2d")]
        let angular_inertia = RigidBodyAngularInertia::new(1.0);
        #[cfg(feature = "3d")]
        let angular_inertia = RigidBodyAngularInertia::new(Vector::ONE);
