...
mod tests {
    ...
    fn rasterizes_compound() {
        ...
        assert_eq!(
            trimesh.vertices,
            vec![
                Vector::new(1.6634157, -1.0794014, -4.3549633),
                Vector::new(2.0867758, -1.0794013, -1.3849857),
                Vector::new(1.1165171, -0.8807319, -1.2466788),
                Vector::new(0.693157, -0.88073176, -4.2166567),
                Vector::new(2.056778, 0.8807319, -4.411036),
                Vector::new(2.480138, 0.88073176, -1.4410582),
                Vector::new(1.5098794, 1.0794014, -1.3027513),
                Vector::new(1.0865194, 1.0794013, -4.272729),
                Vector::new(14.886956, 1.6019983, -1.6440064),
                Vector::new(14.485324, 2.0, -1.6270921),
                Vector::new(15.277318, 2.0, -1.7399881),
                Vector::new(14.875686, 2.3980017, -1.7230738)
            ]
        );
        assert_eq!(
            trimesh.indices,
