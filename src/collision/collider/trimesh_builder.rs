...
mod tests {
    ...
    fn rasterizes_compound() {
        ...
        assert_eq!(
            trimesh.vertices,
            vec![
                Vector::new(1.6634156046802073, -1.0794012104819941, -4.354963570435039),
                Vector::new(2.086775603322501, -1.079401210481994, -1.3849860769934481),
                Vector::new(1.1165170453015136, -0.8807318727109551, -1.2466790821715974),
                Vector::new(0.6931570466592198, -0.8807318727109549, -4.2166565756131895),
                Vector::new(2.0567779125581613, 0.8807319423722887, -4.411036004147714),
                Vector::new(2.480137911200455, 0.8807319423722885, -1.4410585107061231),
                Vector::new(1.5098793531794676, 1.0794012801433277, -1.3027515158842724),
                Vector::new(1.0865193545371739, 1.0794012801433275, -4.2727290093258645),
                Vector::new(14.886956777274035, 1.60199840348629, -1.6440063661356903),
                Vector::new(14.485324381553463, 2.0000000696613336, -1.627092099091476),
                Vector::new(15.277318379804553, 2.0000000696613336, -1.739988098729421),
                Vector::new(14.875685984083981, 2.398001735836377, -1.7230738316852063)
            ]
        );
        assert_eq!(
            trimesh.indices,
