...
pub trait CollisionHooks: SystemParam + Send + Sync {
    ...
    fn modify_contacts(&self, contacts: &mut Contacts, par_commands: Commands) -> bool {
        true
    }
}
...
bitflags::bitflags! {
    impl ActiveCollisionHooks: u8 {
        ...
        /// No hooks are called for collisions with this entity, unless the other entity has [`ActiveCollisionHooks`] set.
        const NONE = 0b0000_0000;
        /// All hooks are called for collisions with this entity.
        const ALL = Self::FILTER_PAIRS.bits() | Self::MODIFY_CONTACTS.bits();
    }
}
