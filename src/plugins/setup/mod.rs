...
impl Plugin for PhysicsSetupPlugin {
    fn build(&self, app: &mut App) {
        ...
        app.insert_resource(Time::new_with(Physics::default()))
            ...
            .init_resource::<BroadCollisionPairs2d>()
            .init_resource::<BroadCollisionPairs3d>()
            ...
            .register_type::<BroadCollisionPairs2d>()
            .register_type::<BroadCollisionPairs3d>()
            .register_type::<SleepingThreshold>()
            .register_type::<DeactivationTime>()
            .register_type::<Gravity>()
            .register_type::<RigidBody2d>()
            .register_type::<RigidBody3d>()
            .register_type::<Sleeping>()
            .register_type::<SleepingDisabled>()
            .register_type::<TimeSleeping>()
            .register_type::<Position2d>()
            .register_type::<Rotation2d>()
            .register_type::<PreviousPosition2d>()
            .register_type::<PreviousPosition3d>()
            .register_type::<PreviousRotation2d>()
            .register_type::<PreviousRotation3d>()
            .register_type::<PreviousGlobalTransform>()
            .register_type::<AccumulatedTranslation2d>()
            .register_type::<AccumulatedTranslation3d>()
            .register_type::<LinearVelocity2d>()
            .register_type::<LinearVelocity3d>()
            .register_type::<AngularVelocity2d>()
            .register_type::<AngularVelocity3d>()
            .register_type::<PreSolveLinearVelocity2d>()
            .register_type::<PreSolveLinearVelocity3d>()
            .register_type::<PreSolveAngularVelocity2d>()
            .register_type::<PreSolveAngularVelocity3d>()
            .register_type::<Restitution>()
            .register_type::<Friction>()
            .register_type::<LinearDamping>()
            .register_type::<AngularDamping>()
            .register_type::<ExternalForce2d>()
            .register_type::<ExternalForce3d>()
            .register_type::<ExternalTorque2d>()
            .register_type::<ExternalTorque3d>()
            .register_type::<ExternalImpulse2d>()
            .register_type::<ExternalImpulse3d>()
            .register_type::<ExternalAngularImpulse2d>()
            .register_type::<ExternalAngularImpulse3d>()
            .register_type::<GravityScale>()
            .register_type::<Mass>()
            .register_type::<InverseMass>()
            .register_type::<Inertia2d>()
            .register_type::<Inertia3d>()
            .register_type::<InverseInertia2d>()
            .register_type::<InverseInertia3d>()
            .register_type::<CenterOfMass2d>()
            .register_type::<CenterOfMass3d>()
            .register_type::<ColliderDensity>()
            .register_type::<ColliderMassProperties2d>()
            .register_type::<ColliderMassProperties3d>()
            .register_type::<LockedAxes2d>()
            .register_type::<LockedAxes3d>()
