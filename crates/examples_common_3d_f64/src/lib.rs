...
use bevy_xpbd_3d_f64::{XpbdLoop, XpbdPlugin};
...
impl Plugin for XpbdExamplePlugin {
    fn build(&self, app: &mut App) {
        app.add_plugin(XpbdPlugin)
            ...
            .add_state::<AppState>()
            .add_system(bevy_xpbd_3d_f64::pause.in_schedule(OnEnter(AppState::Paused)))
            .add_system(bevy_xpbd_3d_f64::resume.in_schedule(OnExit(AppState::Paused)))
