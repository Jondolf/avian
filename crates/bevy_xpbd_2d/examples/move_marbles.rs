...
fn setup(
    ...
    let _floor = commands.spawn((
        ...
        RigidBodyBundle::new_static().with_pos(Vector2::new(0.0, -7.5)),
    ...
    let _left_wall = commands.spawn((
        ...
        RigidBodyBundle::new_static().with_pos(Vector2::new(-9.5, 0.0)),
            ...
            commands.spawn((
                PbrBundle {
                    ...
                    transform: Transform {
                        ...
                        translation: pos.extend(0.0).as_f32(),
                        ..default()
                    },
                    ..default()
                },
                ...
                MaxVelocity(Vector2::new(30.0, 30.0)),
            ));
        }
    }
...
fn main() {
    ...
    App::new()
        ...
        .insert_resource(Gravity(Vector2::new(0.0, -9.81)))
